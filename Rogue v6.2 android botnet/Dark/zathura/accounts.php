	...
	<main class="full-box main-container">
		...
		<section class="full-box page-content">
			...
			<div class="full-box page-header">
				<h3 class="text-left">
					<i class="fas fa-user-alt"></i> &nbsp; Account Manager
				</h3>
			...
			<div class="container-fluid">
				<form action="" class="form-neon" autocomplete="off">
					<fieldset>
						<legend> &nbsp; Linked Accounts will be displayed here.</legend>
						<div class="container-fluid">
							<div class="row">
                 ...
                 $query = ("SELECT  clm_device_emails FROM `tbl_emails` WHERE `clm_device_number` = $content" );

 
                 if ($result = $mysqli->query($query)) {
                     while ($row = $result->fetch_assoc()) {
                   $emails = $row['clm_device_emails'];           
