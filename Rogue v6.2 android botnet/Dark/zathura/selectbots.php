...
background: #fe346e;
padding: 8px;
border: 2px solid #fe346e !important;
...
@keyframes fadeout {
  ...
  to {bottom: 0; opacity: 0;}
	...
	<main class="full-box main-container">
        ...
        echo '<tr> 
		<td> <a href="selectbots.php" onclick="clickfunc(this)"> '.$field2name.'</a></td>
			...
			<div id="container">
				<?php
                   ...
                   ?>
                           ...
                           <button onclick="command(disconnect)" type="button" id="button1" >Disconnect All</button>
						   
                            <button  onclick="location.href = 'all_bots.php';" type="button" id="button2">Select All</button>
                             </div>
			</div>
			
                            <script>
                           function command(meow) { 
                             ...
                             <div id="snackbar">All Bots Disconnected </div>
